          ...
          <div className="max-w-5xl mx-auto">
            <div className="mb-6">
              ...
              {pendingCount > 0 && canGenerateMetadata && <div className="flex justify-center mt-8">
                  <Button onClick={handleProcessImages} disabled={isProcessing || !apiKey} className="glow-button bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 text-lg rounded-md shadow-lg transition-all duration-300 border-none">
                    {isProcessing ? <>
              ...
              {!canGenerateMetadata && <div className="bg-amber-900/30 border border-amber-800/50 rounded-lg p-4 flex items-center mt-4">
