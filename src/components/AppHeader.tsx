  ...
  return <header className="bg-secondary border-b border-gray-700 py-2 px-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          {user && <>
              <Button variant="outline" size="sm" className="text-amber-500 border-amber-700 hover:bg-amber-900/20 transition-all duration-300 hover:shadow-md" onClick={() => navigate('/pricing')}>
                <CreditCard className="h-4 w-4 mr-1" />
                Pricing
              </Button>
              
              <Button variant="outline" size="sm" className="text-blue-500 border-blue-700 hover:bg-blue-900/20 transition-all duration-300 hover:shadow-md" onClick={openSupportPage}>
