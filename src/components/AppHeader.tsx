...
const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  const openWhatsAppSupport = () => {
    window.open("https://wa.me/message/O5LMYSSX2PHSI1", "_blank");
  };
        ...
        <div className="flex items-center space-x-4">
          ...
          {user && <>
              ...
              <Button 
                variant="whatsapp" 
                size="sm" 
                className="transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1 rounded-md text-green-500 [&_svg]:text-green-500" 
