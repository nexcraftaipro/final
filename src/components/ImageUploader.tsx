...
const ImageUploader: React.FC<ImageUploaderProps> = ({ onImagesSelected, isProcessing }) => {
  ...
  return (
    <div className="w-full space-y-2 animate-slide-up">
      ...
      <div
        className={`drop-zone flex flex-col items-center justify-center p-8 transition-all duration-300 ${
      ...
      <div className="text-sm text-red-500 flex items-center justify-center">
        ...
        <span>Images are processed and deleted instantly. We don't store them.</span>
      </div>
    </div>
  );
};
