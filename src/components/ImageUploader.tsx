...
const ImageUploader: React.FC<ImageUploaderProps> = ({
  ...
  return <div className="w-full space-y-2 animate-slide-up">
      <h2 className="text-lg font-medium">02. Upload Images and Process</h2>
      
      <div className={`drop-zone flex flex-col items-center justify-center p-8 transition-all duration-300 ${isDragging ? 'drop-zone-active' : ''}`} onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
        ...
        <Button onClick={handleBrowseClick} className="bg-white hover:bg-gray-50 text-primary border border-gray-200" disabled={isProcessing}>
